...
from few_shot_HATT import *
from few_shot_IATT import *
...
test_portions = 0.001          # the proportion of training samples
...
##--------------------------------------------------
## Step 5: Meta-training starting Proto
##--------------------------------------------------
...
for epoch in range(Epoch):
    ...
    for key in data_episode:
        ...
        loss_train_Proto.append(output['loss'])
        acc_vali_Proto.append(output['acc'])
...
# title = 'Feature weights after training Proto'
...
loss_test_Proto = output['loss']
Acc_test_Proto = output['acc']

## Plot of the feature weights learned by Proto
...
##--------------------------------------------------
## Step 5: Meta-training starting Proto_IATT
##--------------------------------------------------
kwargs_dict = {'feature_dim': in_dim}
model = load_Protonet_IATT(**kwargs_dict)
optimizer = torch.optim.Adam(model.parameters(), lr=lr, weight_decay=weight_decay)

Epoch = 10
feature_iter = {}
loss_train_Proto_IATT = []
acc_vali_Proto_IATT = []
...
for epoch in range(Epoch):
    ...
    for key in data_episode:
        ...
        loss_train_Proto_IATT.append(output['loss'])
        acc_vali_Proto_IATT.append(output['acc'])
...
## Plot of the feature weights learned by the proposed method
# feature_last_num = len(feature_iter)-1
# title = 'Feature weights after training Proto_HATT'
# plot_feature_weight_linear(feature = feature_iter[feature_last_num],
#                            title = title,
#                            signal_dim = signal_dim,
#                            noisy_dim = noisy_dim,
...
loss_test_Proto_IATT = output['loss']
Acc_test_Proto_IATT = output['acc']

## Plot of the feature weights learned by Proto_HATT from meta-testing
# feature_metatest = output['fw'].data.numpy()
# title = 'Feature weights after training Proto_IATT'
# plot_feature_weight_linear_metatest(feature = feature_metatest,
#                                     title = title,
#                                     signal_dim = signal_dim,
#                                     noisy_dim = noisy_dim,
...
##--------------------------------------------------
## Step 5: Meta-training starting Proto_FATT
##--------------------------------------------------
kwargs_dict = {'feature_dim': in_dim}
...
for epoch in range(Epoch):
    ...
    for key in data_episode:
        ...
        loss_train_Proto_FATT.append(output['loss'])
        acc_vali_Proto_FATT.append(output['acc'])

        step += 1
    iter += 1

## Plot of the feature weights learned by Proto_FATT
# feature_last_num = len(feature_iter)-1
# title = 'Feature weights after training Proto_FATT'
# plot_feature_weight_linear(feature = feature_iter[feature_last_num],
#                            title = title,
#                            signal_dim = signal_dim,
#                            noisy_dim = noisy_dim,
...
loss_test_Proto_FATT = output['loss']
Acc_test_Proto_FATT = output['acc']

## Plot of the feature weights learned by Proto_FATT from meta-testing
# feature_metatest = output['fw'].data.numpy()
# title = 'Feature weights after training Proto_FATT'
# plot_feature_weight_linear_metatest(feature = feature_metatest,
#                                     title = title,
...
##--------------------------------------------------
## Step 5: Meta-training starting Proto_HATT
##--------------------------------------------------
kwargs_dict = {'feature_dim': in_dim}
model = load_Protonet_HATT(**kwargs_dict)
optimizer = torch.optim.Adam(model.parameters(), lr=lr, weight_decay=weight_decay)

Epoch = 10
feature_iter = {}
loss_train_Proto_HATT = []
acc_vali_Proto_HATT = []
...
for epoch in range(Epoch):
    ...
    for key in data_episode:
        ...
        loss_train_Proto_HATT.append(output['loss'])
        acc_vali_Proto_HATT.append(output['acc'])
...
loss_test_Proto_HATT = output['loss']
Acc_test_Proto_HATT = output['acc']
...
##--------------------------------------------------
## Step 7: Plot train loss and validation accuracy
##--------------------------------------------------
# title = 'Loss and accuracy of different methods on the training and validation dataset'
# plot_result(loss_train_Proto, loss_train_Proto_IATT, loss_train_Proto_FATT, loss_train_Proto_HATT,
#             acc_vali_Proto, acc_vali_Proto_IATT, acc_vali_Proto_FATT, acc_vali_Proto_HATT,
#             iter_times, figsize, title)


loss_test_list = [loss_test_Proto, loss_test_Proto_IATT, loss_test_Proto_FATT, loss_test_Proto_HATT]
acc_test = [Acc_test_Proto, Acc_test_Proto_IATT, Acc_test_Proto_FATT, Acc_test_Proto_HATT]
acc_test_list = [i*100 for i in acc_test]
print('Loss_test: ', loss_test_list, '\n', 'Acc_test:', acc_test_list)

# title = 'Loss and Accuracy of different methods on the test dataset'
# plt.figure(figsize=(figsize, figsize))
# plt.subplot(211)
# plt.title(title)
# plt.bar(range(len(loss_test_list)), loss_test_list, width=0.4, fc='c')
# plt.subplot(212)
# plt.bar(range(len(acc_test_list)), acc_test_list, width=0.4, fc='c')
# plt.ylim((70,100))
# plt.show()
# plt.close()
